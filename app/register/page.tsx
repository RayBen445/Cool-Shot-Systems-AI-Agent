  ...
  return (
    <div className="relative flex min-h-screen items-center justify-center px-4 py-12">
      ...
      <div className="pointer-events-none absolute inset-0">
        <div className="absolute top-1/4 right-1/4 h-[400px] w-[400px] translate-x-1/2 -translate-y-1/2 rounded-full bg-primary/20 blur-[100px]" />
        <div className="absolute bottom-1/4 left-1/4 h-[300px] w-[300px] -translate-x-1/2 translate-y-1/2 rounded-full bg-accent/20 blur-[80px]" />
      </div>
              ...
              <div>
                ...
                <div className="relative">
                  ...
                  <input
                    ...
                    required
                    className={cn(
                      "w-full rounded-xl border bg-background py-3 pl-10 pr-4 transition-colors focus:outline-none focus:ring-1",
